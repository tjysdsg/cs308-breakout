...
public class Collider {
    /**
     * Maintain a list of the colliders that are in collision with this,
     * so that their collision won't be repeatedly registered
     */
     ...
     * @return `Collision.pos` collision position on surface of `a`
     * `Collision.normal` normal vector pointing outwards from the surface of `a`, has a magnitude of 1
     */
     ...
     * NOTE: not considering the case where the center of rectangle is inside the sphere
     * TODO: Continuous Collision Detection is probably needed when powered up (ball is moving fast)
     *
